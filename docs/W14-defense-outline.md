...
> **截止**: 2026-06-20  
> **作者**: 项目组  
> **配套文档**: `docs/SIGNIN_METHODS.md` / `docs/superpowers/plans/2026-06-07-W12-p0-fixes-and-deliverables.md`
> **演示视频**: 见 `submission/04_DEMO_VIDEO_SCRIPT.md`（W15+ cleanup 时 demo_narration.md/.srt 已被它替代）
